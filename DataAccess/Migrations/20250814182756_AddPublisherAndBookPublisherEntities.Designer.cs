...
namespace BabsKitapEvi.DataAccess.Migrations
{
    ...
    [Migration("20250814182756_AddPublisherAndBookPublisherEntities")]
    partial class AddPublisherAndBookPublisherEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BabsKitapEvi.Entities.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BabsKitapEvi.Entities.Models.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BabsKitapEvi.Entities.Models.BookCategory", b =>
                {
                    b.HasOne("BabsKitapEvi.Entities.Models.Book", "Book")
                        .WithMany("BookCategories")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BabsKitapEvi.Entities.Models.Category", "Category")
                        .WithMany("BookCategories")
            ...
            modelBuilder.Entity("BabsKitapEvi.Entities.Models.BookPublisher", b =>
                {
                    ...
                    b.HasOne("BabsKitapEvi.Entities.Models.Publisher", "Publisher")
                        .WithMany("BookPublishers")
            ...
            modelBuilder.Entity("BabsKitapEvi.Entities.Models.Cart", b =>
                {
                    b.HasOne("BabsKitapEvi.Entities.Models.AppUser", "User")
                        .WithOne("Cart")
                        .HasForeignKey("BabsKitapEvi.Entities.Models.Cart", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BabsKitapEvi.Entities.Models.CartItem", b =>
                {
                    ...
                    b.HasOne("BabsKitapEvi.Entities.Models.Cart", "Cart")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("BabsKitapEvi.Entities.Models.AppRole", null)
                        .WithMany()
