    ...
    public static class SeedData
    {
        ...
        private static async Task SeedCategoriesAndBooksAsync(ApplicationDbContext context)
        {
            ...
            var books = new List<Book>
            {
                ...
                new Book { Title = "1984", Author = "George Orwell", ISBN = "978-975-07-1852-9", PublishedDate = new DateTime(1949, 6, 8), Description = "Totaliter rejim ve 'Büyük Birader'.", ImageUrl = "https://i.dr.com.tr/cache/600x600-0/originals/0000000404463-1.jpg", StockQuantity = 75, Price = 98.75m, BookCategories = new List<BookCategory> { new BookCategory { Category = categories["Distopya"] }, new BookCategory { Category = categories["Klasik"] } } },
